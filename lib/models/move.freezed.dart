...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Move&&(identical(other.tileId, tileId) || other.tileId == tileId)&&(identical(other.direction, direction) || other.direction == direction));
}
...
class _Move implements Move {
  const _Move({required this.tileId, required this.direction});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Move&&(identical(other.tileId, tileId) || other.tileId == tileId)&&(identical(other.direction, direction) || other.direction == direction));
}
